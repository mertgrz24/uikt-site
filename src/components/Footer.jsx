const socials = [
  {
    label: 'Instagram',
    href: 'https://www.instagram.com/banu.uikt/',
    icon: (
  ...
  },
  {
    ...
    href: 'https://chat.whatsapp.com/IXohgyDG2hN0J0CC1Z8HE0',
    icon: (
  ...
  {
    label: 'LinkedIn Grubu',
    href: 'https://www.linkedin.com/groups/9888043/',
    icon: (
      <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  ...
  return (
    <footer className="border-t border-gray-800 bg-[#0a0a0a]">
      <div className="max-w-6xl mx-auto px-4 md:px-8 py-12 flex flex-col items-center text-center gap-4">
        ...
        <div className="w-full border-t border-gray-800 mt-4 pt-4">
          <p className="text-xs text-gray-500">© 2026 UIKT. Tüm hakları saklıdır.</p>
        </div>
